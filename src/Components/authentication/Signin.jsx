...
const SignIn = () => {
    ...
    const handleSignin = (e) => {
        ...
        if (userData.role === 'Customer') {
            axios.post(`http://localhost:5000/api/users/login-user`, userData).then(res => {
                setAuth(res.data)
            ...
            axios.post(`http://localhost:5000/api/users/login-admin`, userData).then(res => {
                setAuth(res.data)
                setSignUpError(false)
                emptyData();
            }).catch(function (e) {
            ...
            axios.post(`http://localhost:5000/api/users//login-moderator`, userData).then(res => {
                setAuth(res.data)
                setSignUpError(false)
                emptyData();
            }).catch(function (e) {
